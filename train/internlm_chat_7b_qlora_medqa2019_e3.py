...
data_path = '/root/RecipeAssistant/data/train_6.json'
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            data_files=dict(train='/root/RecipeAssistant/data/tran_6.json'),
            path='json',
...
visualizer = None
weight_decay = 0
work_dir = './work_dirs/internlm_chat_7b_qlora_medqa2019_e3'
